...
In addition to its use at [Fastmail](https://www.fastmail.com), it is also currently used in production at [ProtonMail](https://protonmail.com/), [SnappyMail](https://github.com/the-djmaze/snappymail), [StartMail](https://startmail.com/), [Tutanota](https://tutanota.com), [Zoho Mail](https://www.zoho.com/mail/), [Superhuman](https://superhuman.com/) and [FlowCrypt](https://flowcrypt.com/), as well as other non-mail apps including [Google Earth](https://www.google.com/earth/) and [Teamwork Desk](https://www.teamwork.com/desk/) (drop me a line if you're using Squire elsewhere, I'm always interested to hear about it!).
